  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if (isRequired && !validators.required(value)) {
        return customMessage || field.getAttribute('data-required-message') || 'This field is required.';
      }
      ...
      if ((type === 'tel' || name.toLowerCase().includes('phone')) && !validators.phone(value)) {
        return field.getAttribute('data-phone-message') || 'Please enter a valid phone number.';
      }

      if (minLength && !validators.minLength(value, minLength)) {
        return field.getAttribute('data-minlength-message') || 'Please enter at least ' + minLength + ' characters.';
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .then(function () {
          ...
          successEl.textContent = contactForm.getAttribute('data-success-message') || 'Thank you! Your message has been sent successfully.';
        ...
        .catch(function () {
          let errorEl = contactForm.querySelector('.form-error-message');
          if (!errorEl) {
          ...
          errorEl.textContent = contactForm.getAttribute('data-error-message') || 'Something went wrong. Please try again later.';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ElunaSleep משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b48a6f99-2a7a-4986-88ce-08a5f71a0d1a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b48a6f99-2a7a-4986-88ce-08a5f71a0d1a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b48a6f99-2a7a-4986-88ce-08a5f71a0d1a';
